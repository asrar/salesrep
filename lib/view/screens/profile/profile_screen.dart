...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // backgroundColor: Color(0xff0381F8),
        ...
        return authController.profileModel == null ? Center(child: CircularProgressIndicator()) : ProfileBgWidget(
          ...
          circularImage: Container(
            decoration: BoxDecoration(
              border: Border.all(width: 2, color: Color(0xffFDA613)),
              shape: BoxShape.circle,
            ),
            alignment: Alignment.center,
            child: ClipOval(child: authController.profileModel.image != null ?  FadeInImage.assetNetwork(
            ...
            ): Image.asset("assets/image/profile_bg.png")),
          ),
