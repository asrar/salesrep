                  ...
                  return Column(
                    ...
                    Row(
                      ...
                      TextButton(
                        ...
                        child: Text('${'forgot_password'.tr}?',style: TextStyle(color: Color(0xffFDA613)),),
                      ),
                    ]),
                    SizedBox(height: 50),
                    ...
                    Get.find<SplashController>().configModel.toggleDmRegistration ? TextButton(
                      ...
                      child: RichText(
                             ...
                             TextSpan(text: '${'join_as_a'.tr} ', style: robotoRegular.copyWith(color: Theme.of(context).disabledColor)),
                              TextSpan(text: 'Service_Provider'.tr, style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyText1.color)),
                      ])),
                    ) : SizedBox(),
