...
//           return orderController.orderNewModelDetails != null ? Column(children: [
//
...
//
//                 InfoCard(
//                   title: 'customer_contact_details'.tr, address: orderModel.deliveryAddress == null ? "":orderModel.deliveryAddress.address.toString(),
...
//                       height: 50,
//                       width: 120,
//                       decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.RADIUS_EXTRA_SMALL),color: Colors.white),
//                       child: Center(child: Text("Fan Repairing",style: TextStyle(color: Colors.black),),),
//                     ),
//                     SizedBox(height: 10,),
//                     Text("Estimate Price:",),
//                     Container(
...
//                       width: 120,
//                       decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.RADIUS_EXTRA_SMALL),color: Colors.white),
//                       child: Center(child: Text("1000 R/S",style: TextStyle(color: Colors.black),),),
//
//                     ),
//                     SizedBox(height: 10,),
//                     Text("Service Note:"),
...
//                                   borderRadius: BorderRadius.circular(Dimensions.RADIUS_EXTRA_SMALL)
//                               ),
//                               child: Center(child: Text("2023/02/02",style: TextStyle(color: Colors.black),)),
//                             )
//                           ],
//                         ),
//                         Column(
...
//                                   borderRadius: BorderRadius.circular(Dimensions.RADIUS_EXTRA_SMALL)
//                               ),
//                               child: Center(child: Text("15:45",style: TextStyle(color: Colors.black),)),
//                             ),
//
//                           ],
//                         )
...
//                 //         decoration: BoxDecoration(color:Color(0xffFDA613) , borderRadius: BorderRadius.circular(5)),
//                 //         child: Text(
...
//              || orderModel.orderStatus == 'processing' || orderModel.orderStatus == 'confirmed') ? Container() : _showSlider ? (orderModel.paymentMethod == 'cash_on_delivery' && orderModel.orderStatus == 'accepted'
...
//                     ? 'Confirmed_Your_Services'.tr : orderModel.orderStatus == 'picked_up' ? 'Service_Delivered'.tr
//                     : orderModel.orderStatus == 'handover' ? 'swipe_to_pick_up_order'.tr : '',
//                 style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: Colors.black),
//               ),
            ...
            Expanded(child: SingleChildScrollView(
              ...
              child: Column(children: [
                ...
                InfoCard(
                  title: 'customer_contact_details'.tr, address:orderModel.deliveryAddress == null ? "":orderModel.deliveryAddress.address.toString(),
                  image: '${Get.find<SplashController>().configModel.baseUrls.customerImageUrl}/${orderModel.customer.image}',
                  name: orderModel.deliveryAddress==null? "":orderModel.deliveryAddress.contactPersonName.toString(), phone: orderModel.deliveryAddress==null? "":orderModel.deliveryAddress.contactPersonNumber.toString(),
                  latitude: orderModel.deliveryAddress==null? "":orderModel.deliveryAddress.latitude, longitude:orderModel.deliveryAddress==null? "": orderModel.deliveryAddress.longitude,
                  showButton: orderModel.orderStatus != 'delivered',
                ),
                SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
            ...
            _showBottomView ? ((orderModel.orderStatus == 'accepted' && (orderModel.paymentMethod != 'cash_on_delivery' || _restConfModel || _selfDelivery))
              ...
              action: () {
                if(orderModel.paymentMethod == 'cash_on_delivery' && orderModel.orderStatus == 'accepted' && !_restConfModel && !_selfDelivery) {
                  Get.dialog(ConfirmationDialog(
                    icon: Images.warning, title: 'are_you_sure_to_confirm'.tr, description: 'you_want_to_confirm_this_order'.tr,
                    //TODO: 1st step to confirm
                    onYesPressed: () {
                      orderController.updateOrderStatus(                        orderUserID:'100',
                          orderID: '100',
                          status: 'confirmed',
                          back: true).then((success) {
                        if(success) {
                          Get.find<AuthController>().getProfile();
                          Get.find<OrderController>().getCurrentOrders();
                        }
                  ...
                  if(Get.find<SplashController>().configModel.orderDeliveryVerification
                    ...
                    Get.find<OrderController>().updateOrderStatus(                        orderUserID:'100',
                        orderID: '100',
                        status: 'confirmed',
                        back: true).then((success) {
                      if(success) {
