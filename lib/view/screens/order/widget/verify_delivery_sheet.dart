...
class VerifyDeliverySheet extends StatelessWidget {
  ...
  VerifyDeliverySheet(
      {@required this.orderIndex, @required this.verify, @required this.orderAmount, @required this.cod});
        ...
        return Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            cod ? Column(children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                Text(
                  ...
                  style: robotoBold.copyWith(fontSize: Dimensions
                      .FONT_SIZE_LARGE),
                ),
            ...
            verify ? Column(children: [
              SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
              Text('collect_otp_from_customer'.tr, style: robotoRegular,
                  textAlign: TextAlign.center),
              SizedBox(height: 40),
            ...
            (verify && orderController.otp.length != 4)
              ...
              onPressed: () {
                Get.find<OrderController>().updateOrderStatus(orderUserID: '100',
                    orderID: '100',
                    status: 'confirmed', back: true).then((success) {
                  if (success) {
