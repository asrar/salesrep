...
class AppConstants {
  static const String APP_NAME = 'Service Provider';

  //static const String BASE_URL = 'https://admin.salvafastfood.com';
  static String userTokenFromLocalDB = '';

  static const String BASE_URL = 'https://s3bits.com/pureworker';//'https://s3bits.com/rooftech';  //https://s3bits.com/delivery-admin
  ...
  static const String UPDATE_ORDER_STATUS_URI = '/api/v1/update-order-status/';
  ...
  static  String ORDER_URI='/api/v1/order-details_data/';
  static  const String ORDER_REQUEST_GET_URI = '/api/v1/customer/get_request/';
  // Shared Key
